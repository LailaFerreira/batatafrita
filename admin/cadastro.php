...
<div class="container">
        ...
        <form class="form col-md-12 center-block" action="insert.php" method="POST">
               ...
               <br/>
                ...
                <?php 
                $regra = (date("s") / date("m"));
                echo 'Codígo: [ ' . $regra . ' ]<br>';
                echo'<br/><input type="text" name="regra" class="form-control" value="" placeholder="Validar">';
                 
                      
                ?>


                <input type="hidden" name="gerarchave" value="<?php echo $regra; ?>">
                <br/><br/>
