...
<div class="container">
        ...
        <form class="form col-md-12 center-block" action="insert-conf.php" method="POST">
        	...
        	<br/>
             	 <input type="text" name="conf_background" class="form-control" placeholder="Caminho da imagem">
        	<br/>
